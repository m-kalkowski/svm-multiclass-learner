...
SvmnuOvaLearner::SvmnuOvaLearner()
{
...
void SvmnuOvaLearner::train(sample_type &trainSamples,
                           ...
                           std::string modelName)
{
    ...
    typedef one_vs_all_trainer<any_trainer<matrix<double, 0, 0>>> ova_trainer;
    ova_trainer trainer;
...
void SvmnuOvaLearner::predict(sample_type &testSamples,
